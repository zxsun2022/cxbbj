					...
					items: [
						...
						// ========== 4. 因果不虚 ==========
						{
							...
							items: [
								...
								{ label: '03邪淫(6h)', link: '/4yg/03/' },
								{ label: '04妄语(6h)', link: '/4yg/04/' },
								{ label: '05离间语(6h)', link: '/4yg/05/' },
								{ label: '06粗恶语(6h)', link: '/4yg/06/' },
								{ label: '07绮语(6h)', link: '/4yg/07/' },
								{ label: '08贪心(6h)', link: '/4yg/08/' },
								{ label: '09害心(6h)', link: '/4yg/09/' },
								{ label: '10邪见(6h)', link: '/4yg/10/' },
								{ label: '11护生(6h)', link: '/4yg/11/' },
								{ label: '12布施(6h)', link: '/4yg/12/' },
								{ label: '13持戒(6h)', link: '/4yg/13/' },
								{ label: '14实语(6h)', link: '/4yg/14/' },
								{ label: '15和语(6h)', link: '/4yg/15/' },
								{ label: '16爱语(6h)', link: '/4yg/16/' },
								{ label: '17法语(6h)', link: '/4yg/17/' },
								{ label: '18舍心(6h)', link: '/4yg/18/' },
								{ label: '19慈心(6h)', link: '/4yg/19/' },
								{ label: '20正见(6h)', link: '/4yg/20/' },
								{ label: '21业之自性(30h)', link: '/4yg/21/' },
								{ label: '22解脱利益(30h)', link: '/4yg/22/' },
								{ label: '23依止上师', link: '/4yg/23/' },
							]
						},
					],
				},
